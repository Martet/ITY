...
\usepackage[a4paper, total={18cm, 25cm}, left=18mm, top=18mm]{geometry}

\title{Typografie a publikování\,--\,1. projekt}
\author{Martin Zmitko\\ \href{mailto:xzmitk01@stud.fit.vutbr.cz}{xzmitk01@stud.fit.vutbr.cz}}
\date{}
...
V~češtině se používají uvozovky typu \uv{9966} místo anglických \say{uvozovek} nebo dvojitých "uvozovek".
